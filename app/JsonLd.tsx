          ...
          itemListElement: [
            {
              ...
              itemOffered: {
                ...
                description:
                  'Strategic brand identities including logo suites, colour palettes, typography systems, and brand guidelines.',
              },
            },
            {
              '@type': 'Offer',
              itemOffered: {
                ...
                description:
                  'Custom, mobile-responsive, SEO-optimised websites built on Framer, Squarespace, Webflow, or Next.js — tailored to your brand and goals.',
              },
            },
            {
              '@type': 'Offer',
